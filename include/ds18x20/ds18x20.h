...
uint8_t DS18X20_start_meas( uint8_t with_external, uint8_t id[],onewireclass Tx);
uint8_t DS18X20_read_meas(uint8_t id[], uint8_t *subzero, uint8_t *cel, uint8_t *cel_frac_bits, onewireclass Tx);
